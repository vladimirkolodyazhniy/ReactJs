...
export default class Input extends Component {
    ...
    componentWillReceiveProps(prop) {
        if (prop.defaultValue !== this.props.defaultValue) {
            this.setValue(prop.defaultValue);
        }

        if (prop.customErrorMessage !== this.props.customErrorMessage) {
            this.setState({
                _validationError: prop.customErrorMessage
            });
        }

        if (prop.validators !== this.props.validators) {
            setTimeout(() =>
                this.context.validationForm.validateTouchedFields(this)
            );
        }
    }
